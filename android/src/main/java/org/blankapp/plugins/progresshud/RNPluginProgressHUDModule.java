...
public class RNPluginProgressHUDModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;
    private KProgressHUD hud;

    public RNPluginProgressHUDModule(ReactApplicationContext reactContext) {
        super(reactContext);
